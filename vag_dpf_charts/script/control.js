...
//Названия значений
let name_value_rus = [];
name_value_rus[0] = "Time (ms)";
name_value_rus[1] = "Вычисленная масса сажи (г)";
name_value_rus[2] = "Продолж. регенер. (мин)";
name_value_rus[3] = "Расст. от последней регенер. (км)";
name_value_rus[4] = "Время от последней регенер. (мин)";
name_value_rus[5] = "Масляная зола (г)";
name_value_rus[6] = "Низкое давление. Закрытие EGR (%)";
name_value_rus[7]= "Темп. вход. газа DPF (°C)";
name_value_rus[8] = "Темп. поверхности DPF (°C)";
name_value_rus[9] = "Накопление Nox серы (г)";
name_value_rus[10] = "Колич. впрыска 1 (мг/об)";
name_value_rus[11] = "Колич. впрыска 2 (мг/об)";
name_value_rus[12] = "Колич. впрыска 3 (мг/об)";
name_value_rus[13] = "Пройденное расстояние (км)";
...
function radioBut_XY(name){
	let xAxis, yAxis, lableX, lableY, lableGraf;
	let valueX, valueY;
	let radiosX, radiosY;
